...
export const Whatsapp = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d='M264 384c-41 0-72-22-72-22l-49 13 12-48s-20-31-20-70c0-72 59-132 132-132 68 0 126 53 126 127 0 72-58 131-129 132m-159 29l83-23a158 158 0 00230-140c0-86-68-155-154-155a158 158 0 00-137 236'></path>
    </svg>
  );
};
